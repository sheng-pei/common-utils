...
//
//    private final EnumMap<ExtPatternKind, Selector> selectors = new EnumMap<>(ExtPatternKind.class);
//
...
//    }
//
//    public Name parseExt(String name) {
//        List<ExtPattern> patterns = getPatterns(name);
//        Name ret = parse(patterns, name);
//        if (ret != null) {
//            return ret;
//        }
...
//    }
//
//    public Name parseKnownExt(String name) {
//        List<ExtPattern> patterns = getPatterns(name);
//        Name ret = parse(patterns, name);
//        if (ret == null) {
...
//    }
//
//    private Name parse(List<ExtPattern> patterns, String name) {
//        if (!patterns.isEmpty()) {
//            Optional<Name> optionalExt = patterns.stream()
//                    .map(p -> p.parse(name))
