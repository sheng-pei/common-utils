...
//import ppl.common.utils.ext.pattern.selector.ExtPatternKind;
//
...
//        ExtPatternKind kind = ExtPatternKind.EQUALS;
...
//                        try {
//                            kind = EnumUtils.enumOf(ExtPatternKind.class, chars[j]);
