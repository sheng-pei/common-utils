package ppl.common.utils.argument.value.map;

import ppl.common.utils.argument.value.map.comparable.Max;
import ppl.common.utils.argument.value.map.comparable.MaxOnComparator;
import ppl.common.utils.argument.value.map.comparable.Min;
import ppl.common.utils.argument.value.map.comparable.MinOnComparator;
import ppl.common.utils.argument.value.map.len.Length;
import ppl.common.utils.argument.value.map.len.MaxLength;
import ppl.common.utils.argument.value.map.len.MinLength;
