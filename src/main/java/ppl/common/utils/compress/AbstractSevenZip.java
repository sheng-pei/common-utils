...
public class AbstractSevenZip implements Archive {
    ...
    public AbstractSevenZip(File compressFile, Creator creator) throws SevenZipException, IOException {
    ...
    public void decompressTo(File toDir) {
        try {
            ...
            throw new CompressResolveException("Couldn't create file for decompressing file: " + this.path, e);
        } catch (IOException e) {
    ...
    public void close() throws CompressResolveException {
        try {
            ...
            throw new CompressResolveException("Failed to close rar file: " + this.path);
        }
    }
