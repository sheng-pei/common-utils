...
//import ppl.common.utils.argument.ArgumentException;
...
//
//import static ppl.common.utils.command.Option.LONG_OPTION_PREFIX;
//import static ppl.common.utils.command.Option.SHORT_OPTION_PREFIX;
//
...
//    }
//
//    private final Map<String, Argument<String, ?>> allArguments;
...
//
//    private Command(Map<String, Argument<String, ?>> allArguments,
...
//
//        allArguments.values()
//                .stream().filter(a -> a instanceof Option)
//                .map(a -> (Option<?>) a)
//                .forEach(this::processDefaultOption);
//
//        positions.forEach(this::processPositionArgument);
//
//        if (positions.size() < remainArgs.size()) {
//            List<String> tmp = remainArgs.subList(positions.size(), remainArgs.size());
//            remainArgs.clear();
//            remainArgs.addAll(tmp);
//        }
//    }
//
//    private void processDefaultOption(Option<?> option) {
...
//                    "Option: '{}' is not given.", option), e);
//        }
//    }
//
//    private void processPositionArgument(Position<?> position) {
//        int pos = position.getPosition();
//        if (pos < remainArgs.size()) {
//            position.receive(remainArgs.get(pos));
//        } else {
//            position.receive();
//        }
//
...
//        } catch (ArgumentException e) {
//            throw new CommandLineException(Strings.format(
//                    "Position Argument: '{}' is not given.", position), e);
//        }
//    }
//
...
//            values.computeIfAbsent(option.getName(), k -> new ArrayList<>())
//                    .add(value());
//        }
//
...
//        private Set<Argument<String, ?>> allArguments;
...
//        }
//
//        public void addArguments(List<Argument<String, ?>> arguments) {
//            for (Argument<String, ?> argument : arguments) {
//                addArgument(argument);
//            }
//        }
//
//        public void addArgument(Argument<String, ?> argument) {
