...
public class ValueArgumentNormalizer<K, V, A extends ValueArgument<K, V>> {
    ...
    private ValueArgumentNormalizer(Function<A, String> key,
    ...
    public static <K, V, A extends ValueArgument<K, V>> Builder<K, V, A> newBuilder(String separator, boolean ignoreSeparatorIfNullValue) {
        return new Builder<>(separator, ignoreSeparatorIfNullValue);
    }

    public static class Builder<K, V, A extends ValueArgument<K, V>> {
        ...
        public BiFunction<A, V, String> build() {
            return new ValueArgumentNormalizer<>(key, value, separator, ignoreSeparatorIfNullValue).create();
        }
